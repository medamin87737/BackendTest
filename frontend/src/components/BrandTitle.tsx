...
export const BrandTitle: React.FC<BrandTitleProps> = ({ variant = 'sidebar' }) => {
  ...
  const baseClass = (() => {
    // Mode sombre : bleu sombre dynamique, shadow adoucie
    if (isDark) {
      if (variant === 'hero') {
        return 'inline-block bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 bg-clip-text text-transparent drop-shadow-[0_0_16px_rgba(30,64,175,0.5)]';
      }
      return 'inline-block bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(30,64,175,0.45)]';
    }
