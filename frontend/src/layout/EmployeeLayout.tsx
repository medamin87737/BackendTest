      ...
      <div className="relative z-10 min-h-screen flex bg-transparent text-slate-50">
        ...
        <aside className="hidden lg:flex w-64 flex-col border-r border-white/10 bg-black/40 backdrop-blur-xl">
          <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
            <div className="h-9 w-9 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-700 shadow-lg shadow-emerald-900/40" />
            <div>
              <p className="text-sm font-semibold tracking-wide">Espace Employé</p>
              <p className="text-[11px] text-slate-200">Gestion des activités</p>
            </div>
          </div>

          <nav className="flex-1 px-3 py-4 space-y-1 text-sm">
            <SidebarLink to="/employee" label="Dashboard" />
            <SidebarLink to="/employee/activities" label="Mes activités" />
            <SidebarLink to="/employee/history" label="Historique" />
            <SidebarLink to="/employee/profile" label="Mon profil" />
            <SidebarLink to="/employee/notifications" label="Notifications" />
          </nav>
        ...
        <div className="flex-1 flex flex-col">
          <header className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-black/40 backdrop-blur-xl">
            <div className="flex items-center gap-2 lg:hidden">
              <span className="h-8 w-8 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-700" />
              <div>
                <p className="text-sm font-semibold">Espace Employé</p>
                <p className="text-[11px] text-slate-200">Gestion des activités</p>
              </div>
            </div>
